...
python main.py \
	...
	--arch=resnet50 \
	--config_path=./configs/neurips/iht_imagenet_resnet50_insta_cosinelr_s95_ep100_no_conv1_fc.yaml \
	--workers=20 \
	--fp16 \
	--epochs=100 \
	...
	--exp_name=iht_imagenet_resnet50_oneshot_cosinelr_fp16_s95_ep100_no_conv1_fc \
