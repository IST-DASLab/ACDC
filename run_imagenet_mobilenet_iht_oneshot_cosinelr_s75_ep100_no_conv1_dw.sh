...
python main.py \
	...
	--arch=mobilenet \
	--config_path=./configs/neurips/iht_imagenet_mobilenet_insta_cosinelr_s75_ep100_no_conv1_dw.yaml \
	--workers=20 \
	--epochs=100 \
	--fp16 \
	...
	--exp_name=iht_imagenet_mobilenet_cosinelr_fp16_s75_ep100_no_conv1_dw \
